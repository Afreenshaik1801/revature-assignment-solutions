...
Associate_Passoword varchar(20)
);
alter table Associate_Info change Associate_Passoword Associate_Password varchar(20);
...
End_Date varchar(20),
AFeedbackGiven char(20) default 'No',
TFeedbackGiven char(20) default 'No',
...
(Trainer_id, Salution, Trainer_name, Trainer_Location, Trainer_Track, Trainer_Qualification, Trainer_Experience, Trainer_email, Trainer_Password)
Values
